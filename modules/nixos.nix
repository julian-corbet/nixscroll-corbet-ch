...
# That's it. No module-level wrapper options or default_decoration duplicate of what home-manager
# already owns — the package's fixed Mesa environment is separate. Diax170/scroll-flake's own
